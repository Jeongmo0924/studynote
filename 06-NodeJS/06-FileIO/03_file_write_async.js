...
/** (2) 필요한 변수 생성 */
const target = "c://users/pjm/studynote/06-NODEJS/06-FileIO/output_async.txt"; // 저장할 파일의 경로
const content = "Hello World Async!"; // 저장할 내용
...
if (!isExists) {
  ...
  fs.writeFile(target, content, "utf8", (err) => {
    ...
    console.debug(target + "의 퍼미션 설정을 요청하였습니다.");
  });
  ...
  console.debug(target + "의 파알삭제를 요청했습니다.");
}
