 ...
 * foo.메서드();
 * 
 * 문자열 객체에 내장된 메서드들은 변수가 담고 있는 내용을 가공하거나 특정 내용을 추출하는 기능을 가진다.
...
// 단어나 문장으로 검색할 경우 일치하는 내용이 시작되는 첫 글자의 인덱스를 반환
